...
<head>
    ...
    <link rel="shortcut icon" href="<?=$URL_E;?>/assets/files/img/favicon.ico" type="image/x-icon">
    <link rel="stylesheet" href="<?=$URL_E;?>/assets/css/bootstrap/bootstrap.min.css">
...
<body <?=($URL_A == "active") ? 'class="clientarea"' : '';?>>